...
if (text === "/balance") return sock.sendMessage(sender, { text: `💰 Wallet: ${user.money}€\n🏦 Bank: ${user.bank}€` })
...
if (text === "/bot off") return sock.sendMessage(sender, { text: "🤖 Bot wird ausgeschaltet!" }) // optional implementieren
if (text === "/bot on") return sock.sendMessage(sender, { text: "🤖 Bot läuft!" }) // optional implementieren
}
